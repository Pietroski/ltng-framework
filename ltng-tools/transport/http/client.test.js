...
const { HttpClient, asyncDataParser } = require('./client')
const { MapHttpResponseInfo, ExternalServiceCallErr } = require('./models')
...
Test("MapHttpResponseInfo null response", (t) => {
	const { MapHttpResponseInfo } = require('./models')
...
Test("asyncDataParser invalid body", async (t) => {
	const { asyncDataParser } = require('./client')
