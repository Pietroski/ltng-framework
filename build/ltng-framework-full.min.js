(function() {
window.stories = {}
window.registerStory = function registerStory(name, description, renderFn) {
stories[name] = {
name,
description,
render: renderFn
...
(function() {
const registerStory = window.registerStory;
...
const FlexStyleOpts = window.FlexStyleOpts;
...
const createFormStore = window.createFormStore;
const Div = window.Div;
const Typography = window.Typography;
