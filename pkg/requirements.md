...
The unit tests should be written under `tools/<name-of-the-libtool>/*/*.test.js` (basically, if the libtool is called `my-libtool`, then the unit tests should be written under `tools/my-libtool/my-libtool.test.js` if the target file to be test is under `to_deprecate/my-libtool/my-libtool.js`).
